...
class Collection {
  public:
    ...
    // the record list, restoring all the Record information.
    ...
    // Add the Record, throw exception if there is already a Record with the
    // same title.
  ...
  private:
    /* *** the member information must be kept in a container of Record * -
     * name is your choice
     */
    Ordered_list<Record *>
